...
# Defina as estratégias de validação cruzada
...
cv_results = cross_validate(rf, X_train_selected_features, y_train, cv=cv, scoring=scoring, return_train_score=True)
